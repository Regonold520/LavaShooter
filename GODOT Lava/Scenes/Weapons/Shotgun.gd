...
func _shoot():
	...
	bullet.expiration = 0.3
	get_tree().current_scene.add_child(bullet)
	bullet.global_position = $FirePoint.global_position
	bullet.rotation_degrees = global_rotation_degrees - 180
	
	var bullet2 = Bullet.instantiate()
	bullet2.expiration = 0.3
	get_tree().current_scene.add_child(bullet2)
	bullet2.global_position = $FirePoint.global_position
	bullet2.rotation_degrees = global_rotation_degrees - 160
	
	var bullet3 = Bullet.instantiate()
	bullet3.expiration = 0.3
	get_tree().current_scene.add_child(bullet3)
	bullet3.global_position = $FirePoint.global_position
	bullet3.rotation_degrees = global_rotation_degrees - 200
